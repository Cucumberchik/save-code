...
const TodoCard: NextPage<{
  el: ElementType;
  idx: number;
  setIdTodo: (id: number) => void;
}> = ({ el, idx, setIdTodo }): ReactNode => {
      ...
      <div className="item_title">
        <div className="name_todo">
          ...
          <Typography variant="body">
            {el.date.split(" ")[2]} {el.date.split(" ")[3]}{" "}
            {el.date.split(" ")[4] + " "}
          </Typography>
        </div>
        <span className="lanuage_item">
