...
interface TypographyType {
 ...
 const Typography:FC<TypographyType> = ({variant = "web", children, className}):ReactElement => {
    let fz = {
        web: "500 36px / 122%",
        h1: "500 32px / 125%",
        h2: "500 24px / 117%",
    ...
    switch(variant){
        ...
        case "body": return <Body className={className}>{children}</Body>;
        default: return <Web className={className}>{children}</Web>;
    }
}
